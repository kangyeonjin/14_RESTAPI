...
public class HateoasTestController {
    ...
    * hateoas란?
    * 하나의 api를 동작시켰을때
    * 그 전상황이나 그후 상황에 대한 링크를 제공함으로써 클라이언트가
    * 리소스(자원)에 대한 이해를 더욱 충분히 할수있도록 링크를 제공하는것
    * (hateoas까지 구현했을때, restfull의 성숙도 3단계api(최종단계)라고한다*/
    ...
    public ResponseEntity<ResponseMessage> findAllUsers(){
        ...
        //EntityModel : hateoas제공하는 클래스 rest api를 만들때 해당 자원과 관련된 링크를 포함할수있게 해준다
